      ...
      <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-slate-200 bg-gradient-to-r from-gov-blue/5 to-transparent relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-800 tracking-tight mb-2">
            Welcome, Anjali <span className="inline-block hover:animate-wiggle cursor-default">👋</span>
          </h2>
          <p className="text-slate-600 font-medium">
            Manage your village services efficiently from one place.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-slate-700">Raise Complaint</span>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-slate-700">View Funds</span>
              </div>
              <ArrowRight size={18} className="text-slate-400 group-hover:text-gov-blue transition-colors" />
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-slate-700">Track Expenditure</span>
              </div>
              <ArrowRight size={18} className="text-slate-400 group-hover:text-gov-blue transition-colors" />
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-slate-700">Apply Scheme</span>
              </div>
              <ArrowRight size={18} className="text-slate-400 group-hover:text-gov-blue transition-colors" />
            </Link>
          </div>
